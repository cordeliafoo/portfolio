  ...
  render () {
    return (
      <div className='projectCard'>
        <Thumbnail src='https://i.imgur.com/zLWnhA2.gif' alt='242x200'>
          <H1>the 30 day project</H1>
           <hr />
           <H4>About</H4>
           <P>I'm especially proud of this collection of microsites because it was created as a personal project in an attempt to overcome my phobia of coding and get my feet wet in the world of web development.  The 30DayProject is my personal spin on the #The100DayProject, where I build one small little website a day for 30 days. </P>
           ...
           <hr />
           <H4>Tech Stack</H4>
           <P>Purely Front-End - Javascript(using the p5.js library), HTML, CSS</P>
      ...
      //   <Thumbnail src='https://i.imgur.com/zLWnhA2.gif' className='thumbnail'>
      //     <H1>the 30 day project</H1>
      //
      ...
      //       </Modal.Header>
      //       <Modal.Body>
      //         <img src='http://i.imgur.com/vuiIKci.png' alt='project5'></img>
      //         <hr />
      //         <H4>About</H4>
